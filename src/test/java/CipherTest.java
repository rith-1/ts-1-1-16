...
*/
    ...
    */
    ...
    @Test
    void loadKeyOne_invalidPath_doesNotThrow_andReturnsNull() {
        Cipher cipher = new Cipher();

        assertDoesNotThrow(() -> {
            String result = cipher.loadKey("this_file_does_not_exist.txt");
            assertNull(result, "loadKey should return null on file not found");
        });

        // state should remain unchanged
        assertEquals("", cipher.getActual());
        assertEquals("", cipher.getCipher());
    }

    @Test
    void loadKeyTwo_emptyPath_doesNotThrow_andReturnsNull() {
        Cipher cipher = new Cipher();

        assertDoesNotThrow(() -> {
            String result = cipher.loadKey("");
            assertNull(result, "loadKey should return null on invalid path");
        });
